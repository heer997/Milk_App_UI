...
class MotherDairyDahi extends StatefulWidget {
  ...
  @override
  State<MotherDairyDahi> createState() => _MotherDairyDahiState();
}

class _MotherDairyDahiState extends State<MotherDairyDahi> {
          ...
          child: SizedBox(
            ...
            child: Column(
              children: <Widget>[
                ...
                Image.asset("assets/images/MotherDairy_dahi.jpeg",
