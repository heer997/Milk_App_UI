...
import "package:wscubetech_app_ui/Category/Ghee_Category/Nestle_Ghee/NestleGhee_Notifications.dart";

class NestleGhee extends StatefulWidget {
  const NestleGhee({super.key});

  @override
  State<NestleGhee> createState() => _NestleGheeState();
}

class _NestleGheeState extends State<NestleGhee> {
          ...
          IconButton(
            onPressed: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) {
                    return NestleGheeNotifications();
                  },
                ),
              );
            },
          ...
          child: SizedBox(
            ...
            child: Column(
              children: <Widget>[
                ...
                Image.asset("assets/images/Nestle_Ghee.jpg",
