...
class AmulButterMilk extends StatefulWidget {
  ...
  @override
  State<AmulButterMilk> createState() => _AmulButterMilkState();
}

class _AmulButterMilkState extends State<AmulButterMilk> {
          ...
          child: SizedBox(
            ...
            child: Column(
              children: <Widget>[
                ...
                Image.asset("assets/images/Amul_ButterMilk.jpg",
